...
AppMobi.app = 'wroGpl.candiez';AppMobi.release = '3.4.0';AppMobi.webRoot = 'http://localhost:58888/wroGpl.candiez/3.4.0/';AppMobi._hasAnalytics = true;AppMobi._hasCaching = true;AppMobi._hasStreaming = true;AppMobi._hasAdvertising = true;AppMobi._hasOAuth = true;AppMobi.oauthAvailable = false;
AppMobi.picturelist=[];